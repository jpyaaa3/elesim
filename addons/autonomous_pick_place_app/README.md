...
```json
{
  ...
  "center_uv": [u, v],
  "mu_camera": [x, y, z],
  "sigma_camera": [sx, sy, sz],
  "depth_valid_ratio": 0.73,
  "lost_count": 0
}
```

YOLO-seg로 1회 lock 후 `perception/target_tracker.py`가 bbox×1.5 ROI depth median + 20프레임 median/MAD를 publish합니다.
...
perception/             # camera, detector, depth_pose, target_tracker, preview
elesim_bridge/
