...
class PerceptionActions:
    ...
    def _start_remote_preview(self) -> None:
        ...
        def _worker() -> None:
            try:
                from elesim_simulator.vision.perception.preview import close_preview, show_preview
                from elesim_simulator.vision.perception.preview_stream import PreviewFrameSubscriber
    ...
    def _start_side_camera_recording(self, record_path: str | Path) -> Optional[Path]:
        ...
        if cfg is None:
            return None
        try:
            from elesim_simulator.vision.sim_camera.recording import SimCameraVideoRecorder
        except Exception as exc:
    ...
    def _capture_side_camera_snapshot(self, paired_path: str | Path) -> Optional[Path]:
        ...
        if cfg is None:
            return None
        try:
            from elesim_simulator.vision.sim_camera.recording import (
