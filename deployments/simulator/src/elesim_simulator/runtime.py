...
class SimScene:
    ...
    def camera_axes_world(self, *, hand_eye_path: str, parent_link: str = "node9") -> Optional[tuple[np.ndarray, np.ndarray, np.ndarray]]:
        ...
        if self.mover is None:
            return None
        try:
            from elesim_simulator.vision.sim_camera.pose import camera_axes_from_genesis_link
    ...
    def prepare_assets(self) -> str:
        ...
        if missing:
            raise FileNotFoundError(
                "prebuilt simulator bundle is incomplete: " + ", ".join(missing)
...
class RuntimePrep:
    ...
    def init_genesis(self, urdf_path: str) -> None:
        ...
        if use_go2 and go2_entity is not None:
            ...
            from elesim_simulator.observability.walking_metrics import WalkingMetricsLogger
