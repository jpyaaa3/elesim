...
# Use explicit imports: elesim_simulator.robot.go2.mpc.controller, elesim_simulator.robot.go2.mpc.config, ...
...
def __getattr__(name: str):
    ...
    if name == "ConvexMpcGenesisController":
        from elesim_simulator.robot.go2.mpc.controller import ConvexMpcGenesisController
    ...
    if name == "payload_pitch_trim_rad":
        from elesim_simulator.robot.go2.mpc.payload_model import payload_pitch_trim_rad
