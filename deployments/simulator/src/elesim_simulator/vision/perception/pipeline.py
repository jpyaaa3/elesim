...
from elesim_simulator.vision.perception.depth_pose import CameraIntrinsics, estimate_object_position_camera
from elesim_simulator.vision.perception.detector import DetectionResult, ObjectDetector
from elesim_simulator.vision.perception.observation import CameraObservation
...
def normalized_detection_center_uv(det: DetectionResult, *, image_width: int, image_height: int) -> tuple[float, float]:
    from elesim_simulator.vision.perception.detection_utils import detection_center_pixel
