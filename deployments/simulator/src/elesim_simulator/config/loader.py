...
from elesim_simulator.config.schema import AppConfigBundle
from elesim_simulator.config.yaml_loader import load_app_config_from_yaml
...
def load_app_config(path: str) -> AppConfigBundle:
    ...
    if suffix == ".ini":
        from elesim_simulator.config.legacy_ini import load_app_config_from_ini
...
def load_app_config_from_ini(path: str) -> AppConfigBundle:
    ...
    from elesim_simulator.config.legacy_ini import load_app_config_from_ini as load_legacy
