...
from elesim_simulator.robot.go2.locomotion.kinematics import HIP_OFFSET_BODY, TROT_PHASE_OFFSET
...
from elesim_simulator.robot.go2.locomotion.types import Go2Command, LegId, LegPhase
