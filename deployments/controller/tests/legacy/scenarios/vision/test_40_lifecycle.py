...
from elesim_controller.vision.perception.capture import PerceptionCapture, PerceptionSnapshot
...
class TestPerceptionStartStop(unittest.TestCase):
    ...
    @patch("elesim_controller.pick.perception.PerceptionCapture", autospec=True)
