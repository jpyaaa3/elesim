...
from elesim_controller.config import PerceptionConfig, load_app_config
...
class TestPerceptionWorkerConfig(unittest.TestCase):
    def test_jetson_ini_loads_camera_mode(self) -> None:
        bundle = load_app_config("deployments/controller/config/config.jetson.yaml")
    ...
    def test_pc_ini_loads_remote(self) -> None:
        bundle = load_app_config("deployments/controller/config/default.yaml")
        pc = bundle.perception_config
