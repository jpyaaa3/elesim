...
from elesim_controller.vision.sim_camera.mount import hand_eye_to_genesis_attach_T, load_hand_eye_offset_T, _OPTICAL_FROM_GENESIS_CAMERA
from elesim_controller.vision.sim_camera.pose import _link_world_transform, camera_axes_from_genesis_camera_object
...
class TestSimCameraMount(unittest.TestCase):
    def test_hand_eye_optical_axes_in_node9(self) -> None:
        cfg = ROOT / "deployments" / "controller" / "config" / "calibration" / "hand_eye.camera.json"
