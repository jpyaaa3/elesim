...
from elesim_controller.robot.go2.locomotion.kinematics import HIP_OFFSET_BODY
from elesim_controller.robot.go2.locomotion.types import Go2Command, LegId
