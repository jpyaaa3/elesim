...
from elesim_controller.robot.go2.locomotion.kinematics import TROT_PHASE_OFFSET
from elesim_controller.robot.go2.locomotion.types import LegId, LegPhase
