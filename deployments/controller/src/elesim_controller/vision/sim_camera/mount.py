...
class Node9EyeInHandCamera:
    ...
    def camera_axes_world(self, *, axis_len_m: float = 0.08) -> Optional[tuple[tuple[float, float, float], ...]]:
        ...
        try:
            from elesim_controller.vision.sim_camera.pose import camera_axes_from_genesis_camera_object
...
class FixedWorldCamera:
    ...
    def _apply_pose(self) -> None:
        from elesim_controller.vision.sim_camera.remote_control import consume_pose
