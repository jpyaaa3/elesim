...
class AimActions:
    ...
    def _pick_ee_axis_world(
        ...
        *,
        ...
        from elesim_controller.robot.arm.iklib.kinematics import _forward_link_tf
    ...
    def _pick_extend_cartesian(
        ...
        """Advance grasp point ``distance_m`` along EE local -Z via ``elesim_controller.robot.arm.ik.solve_then_align``."""
