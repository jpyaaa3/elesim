...
from workbench.research.analysis.analyze_walking_metrics import effective_visibility_flags, summarize_run
...
def main() -> None:
    ...
    ap.add_argument("--out", default="workbench/evidence/generated/experiments/pitch_preview_final")
