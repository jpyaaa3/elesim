"""Pilot composition helper for experiment and debug tools.

Tools that execute Pilot-owned workflows run a real Pilot DDS
...
class ToolControlService:
    ...
    def __init__(
        ...
        *,
        ...
        if role.role != "pilot":
            raise ValueError(
                f"runtime role must be pilot, got {role.role!r}"
            )
...
__all__ = ["ToolControlService", "start_tool_pilot"]
