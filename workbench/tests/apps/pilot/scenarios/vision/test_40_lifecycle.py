...
from elesim_pilot.vision.perception.capture import PerceptionCapture, PerceptionSnapshot
...
class TestPerceptionStartStop(unittest.TestCase):
    ...
    @patch("elesim_pilot.pick.perception.PerceptionCapture", autospec=True)
