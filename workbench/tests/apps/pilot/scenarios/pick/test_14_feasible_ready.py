...
from elesim_pilot.vision.visual_servoing.feasible_ready_pose import (
    _build_candidates,
    resolve_feasible_ready_pose,
)
from elesim_pilot.vision.visual_servoing.pick_view_pregrasp import ViewPregraspCandidate
...
class TestResolveFeasibleReadyPose(unittest.TestCase):
    ...
    def test_camera_score_tiebreak_prefers_higher_score(self) -> None:
        ...
        with patch(
            "elesim_pilot.vision.visual_servoing.feasible_ready_pose._build_candidates",
            return_value=[cand_a, cand_b],
        ), patch(
            "elesim_pilot.vision.visual_servoing.feasible_ready_pose.evaluate_view_candidate",
    ...
    def test_two_phase_runs_full_align_only_for_top_k(self) -> None:
        ...
        with patch(
            ...
            "elesim_pilot.vision.visual_servoing.feasible_ready_pose._default_solve_position_only",
            side_effect=screen_fn,
        ), patch(
            "elesim_pilot.vision.visual_servoing.feasible_ready_pose._make_align_solve_fn",
