...
from elesim_pilot.vision.visual_servoing.feasible_look_pose import resolve_feasible_look_pose
...
class TestFeasibleLookPose(unittest.TestCase):
    def test_fast_path_returns_user_preferred(self) -> None:
        ...
        with patch(
            "elesim_pilot.vision.visual_servoing.feasible_look_pose._build_candidates",
