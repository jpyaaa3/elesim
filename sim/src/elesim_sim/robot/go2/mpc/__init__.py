...
# Use explicit imports: elesim_sim.robot.go2.mpc.controller, elesim_sim.robot.go2.mpc.config, ...
...
def __getattr__(name: str):
    ...
    if name == "payload_pitch_trim_rad":
        from elesim_sim.robot.go2.mpc.payload_model import payload_pitch_trim_rad
