...
Run::
    ...
    python -m elesim_sim.rl.render_scene --out sim/benchmarks/render
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    parser.add_argument("--contact-json", default="sim/benchmarks/workspace.json")
    parser.add_argument("--out", default="sim/benchmarks/render")
