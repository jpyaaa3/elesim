...
class TestCameraVisibility(unittest.TestCase):
    ...
    def test_soft_score_finite_outside_fov(self) -> None:
        from elesim_pilot.vision.visual_servoing.pick_view_pregrasp import camera_visibility_score_soft
...
class TestViewCandidateStrict(unittest.TestCase):
    ...
    @patch("elesim_pilot.vision.visual_servoing.pick_view_pregrasp.evaluate_view_candidate")
