...
class SimConfig:
    ...
    sim_camera_topic: str = "/elesim/sim/rgbd/frame"
...
class HardwareConfig:
    # Display/canonical coordinates: increasing Roll slider increases
    # canonical roll.  Raw motor polarity remains in motor_direction below.
