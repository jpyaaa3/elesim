...
from elesim_pilot.vision.perception.observation import CameraObservation
...
def normalized_detection_center_uv(det: DetectionResult, *, image_width: int, image_height: int) -> tuple[float, float]:
    from elesim_pilot.vision.perception.detection_utils import detection_center_pixel
