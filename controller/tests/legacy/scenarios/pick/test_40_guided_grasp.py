...
from elesim_controller.config import IkConfig, PickConfig
from elesim_controller.pick.actions import ControlService
from elesim_controller.vision.perception.capture import PerceptionSnapshot
from elesim_controller.pick.state import HostState, PanelState
from elesim_protocol import SimMappingConfig, SimQ
from elesim_controller.vision.visual_servoing.equal_sag_probe import EqualSagEstimate
from elesim_controller.vision.visual_servoing.grasp_trajectory import GraspWaypoint
...
class TestGraspGuidedHelpers(unittest.TestCase):
    ...
    def test_lji_motion_fraction_wait_uses_sim_q(self) -> None:
        ...
        with patch("elesim_controller.pick.actions.time.sleep"):
    ...
    def test_grasp_wait_waypoint_settle_dwells(self) -> None:
        ...
        ) as mock_q, patch("elesim_controller.pick.actions.time.sleep") as mock_sleep:
    ...
    def test_null_space_compose_via_module(self) -> None:
        from elesim_controller.vision.visual_servoing.local_image_jacobian import compose_dq_align_and_approach
        ...
        from elesim_controller.vision.visual_servoing.local_image_jacobian import null_space_projector
