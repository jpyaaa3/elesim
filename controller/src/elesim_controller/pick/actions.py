...
from elesim_controller.vision.visual_servoing.grasp_trajectory import (
    GraspWaypoint,
...
from elesim_controller.vision.perception.observation import VisualObservation, extract_local_perception_observation, extract_visual_observation
