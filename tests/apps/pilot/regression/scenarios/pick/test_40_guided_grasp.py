...
from elesim_pilot.config import IkConfig, PickConfig
...
class TestGraspGuidedHelpers(unittest.TestCase):
    ...
    def test_lji_motion_fraction_wait_uses_sim_q(self) -> None:
        ...
        with patch("elesim_pilot.pick.actions.time.sleep"):
    ...
    def test_grasp_wait_waypoint_settle_dwells(self) -> None:
        ...
        ) as mock_q, patch("elesim_pilot.pick.actions.time.sleep") as mock_sleep:
    ...
    def test_null_space_compose_via_module(self) -> None:
        from elesim_pilot.vision.visual_servoing.local_image_jacobian import compose_dq_align_and_approach
        ...
        from elesim_pilot.vision.visual_servoing.local_image_jacobian import null_space_projector
