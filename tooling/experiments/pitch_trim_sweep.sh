...
echo "  elesim-simulator --config deployments/simulator/config/default.yaml"
echo "  python tools/experiments/walking_baseline.py --run-id \$ELESIM_RUN_ID \\"
echo "    --preset bent_upward --motion backward --duration 15 --vx -0.35 --gaze off"
echo ""
echo "Compare:"
echo "  python tools/analysis/analyze_walking_metrics.py --evaluate-trim exp_trim_baseline_001 exp_trim_<case>_001"
