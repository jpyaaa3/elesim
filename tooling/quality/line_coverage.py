...
PROFILES: dict[str, CoverageProfile] = {
    ...
    "router": CoverageProfile(
        ...
        ("packages/protocol/src", "deployments/router/src"),
    ),
    "robot": CoverageProfile(
        "deployments/robot/tests",
        ("packages/protocol/src", "deployments/robot/src"),
    ),
    "controller": CoverageProfile(
        "deployments/controller/tests",
        ("packages/protocol/src", "deployments/controller/src"),
    ),
    "simulator": CoverageProfile(
        "deployments/simulator/tests",
        ("packages/protocol/src", "deployments/simulator/src"),
    ),
    "ui": CoverageProfile(
        "deployments/ui/tests",
        ("packages/protocol/src", "deployments/ui/src"),
    ),
}
