...
TEST_ROOTS = (
    ...
    ROOT / "research/analysis/tests",
    ROOT / "research/debug/tests",
    ROOT / "research/experiments/tests",
)
SOURCE_ROOTS = (
...
PYTEST_LOCATION_RE = re.compile(
    r"^(?:packages|pilot|robot|sim|ui|model|research|tools|installer|system_tests)/.+\.py:\d+(?::|$)"
)
...
TEST_GROUPS += (
    ...
    TestCaseGroup("개발 도구", _under("tools/"), "분석기, 로그뷰어와 실험 CLI의 순수 helper를 확인합니다."),
)
