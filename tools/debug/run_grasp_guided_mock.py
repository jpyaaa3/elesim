...
Example:
  python tools/run_grasp_guided_mock.py --object 0.5 0.0 1.2
  python tools/run_grasp_guided_mock.py --phases aim,grasp
"""
...
def main() -> int:
    ...
    if str(bundle.perception_config.mode).strip().lower() != "mock":
        print(
            "[mock-grasp] warning: [perception] mode is not 'mock' in configs/config.yaml — "
