...
CASES: tuple[MutationCase, ...] = (
    MutationCase(
        ...
        mutant="or False:",
        tests=("tests/protocol/test_protocol_v6.py",),
    ),
    MutationCase(
        ...
        mutant="if False:",
        tests=("tests/protocol/test_peer_authority.py",),
    ),
    MutationCase(
        ...
        mutant="or False",
        tests=("tests/apps/sim/test_endpoint.py",),
    ...
    MutationCase(
        ...
        mutant="if False:",
        tests=("tests/apps/robot/regression/scenarios/go2/test_12_agent_bridge.py",),
        python_paths=("payload/runtime/common/protocol",),
    ),
    MutationCase(
        ...
        mutant="if True:",
        tests=("tests/apps/robot/test_runtime.py",),
        python_paths=("payload/runtime/common/protocol",),
    ),
    MutationCase(
        ...
        tests=("tests/apps/pilot/properties/test_uv_jacobian_properties.py",),
        python_paths=("payload/runtime/common/protocol",),
    ),
    MutationCase(
        ...
        tests=("tests/apps/pilot/properties/test_lji_properties.py",),
        python_paths=("payload/runtime/common/protocol",),
    ),
    MutationCase(
        ...
        mutant="if False:",
        tests=("tests/apps/pilot/properties/test_equal_sag_properties.py",),
        python_paths=("payload/runtime/common/protocol",),
    ),
)
