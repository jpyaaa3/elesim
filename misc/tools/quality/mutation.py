...
CASES: tuple[MutationCase, ...] = (
    MutationCase(
        ...
        mutant="or False:",
        tests=("packages/protocol/tests/test_protocol_v6.py",),
    ),
    MutationCase(
    ...
    MutationCase(
        ...
        mutant="or False",
        tests=("sim/tests/test_endpoint.py",),
    ...
    MutationCase(
        ...
        tests=("pilot/tests/properties/test_uv_jacobian_properties.py",),
        python_paths=("packages/protocol/src",),
    ),
    MutationCase(
        ...
        tests=("pilot/tests/properties/test_lji_properties.py",),
        python_paths=("packages/protocol/src",),
    ),
    MutationCase(
        ...
        mutant="if False:",
        tests=("pilot/tests/properties/test_equal_sag_properties.py",),
        python_paths=("packages/protocol/src",),
    ),
)
