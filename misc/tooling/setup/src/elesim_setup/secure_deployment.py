    ...
    def configure(
        ...
        session.run(
            _configuration_command(
                host,
                values,
                simulator_id=endpoints.get("simulator", ""),
                controller_id=endpoints.get("controller", ""),
    ...
    def restore(
        ...
        session.run(
            _configuration_command(
                host,
                dds,
                simulator_id=str(network.get("simulator_id", "")),
                controller_id=str(network.get("controller_id", "")),
...
def _configuration_command(
    ...
    *,
    ...
    if simulator_id:
        arguments.extend(("--simulator-id", simulator_id))
    if controller_id:
        arguments.extend(("--controller-id", controller_id))
    if ui_id:
