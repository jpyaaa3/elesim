...
CHECKS: tuple[Check, ...] = (
    ...
    Check(
        "controller",
        ("controller/tests",),
        (PROTOCOL_SRC, "controller/src"),
        description="Vision, IK, gaze and Pick control behavior",
    ),
    Check(
        "simulator",
        ("simulator/tests",),
        (PROTOCOL_SRC, "simulator/src"),
    ...
    Check(
        "model-builder",
        ("misc/tooling/model_builder/tests", "misc/tooling/release/tests"),
        (PROTOCOL_SRC, "controller/src", "misc/tooling/model_builder/src"),
    ...
    Check(
        "critical-mutations",
        ("misc/tooling/quality/mutation.py",),
        (PROTOCOL_SRC,),
        group="extended",
        module="script",
    ...
    Check(
        "debug-tools",
        ("misc/tooling/debug/tests",),
        (PROTOCOL_SRC, "controller/src", "ui/src"),
        group="extended",
        description="Manual debugger support code",
    ),
    Check(
        "experiment-tools",
        ("misc/tooling/experiments/tests",),
        (PROTOCOL_SRC, "controller/src", "misc/tooling/model_builder/src"),
        group="extended",
