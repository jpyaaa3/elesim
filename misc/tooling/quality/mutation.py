...
CASES: tuple[MutationCase, ...] = (
    MutationCase(
        ...
        mutant="or False:",
        tests=("packages/protocol/tests/test_protocol_v5.py",),
    ),
    MutationCase(
        ...
        mutant="if False:",
        tests=("packages/protocol/tests/test_peer_authority.py",),
    ),
    MutationCase(
    ...
    MutationCase(
        ...
        mutant="if True:",
        tests=("robot/tests/test_runtime.py",),
        python_paths=("packages/protocol/src",),
    ),
    MutationCase(
        name="uv-control-direction",
        source_root="controller/src",
        ...
        tests=("controller/tests/properties/test_uv_jacobian_properties.py",),
        python_paths=("packages/protocol/src",),
    ),
    MutationCase(
        ...
        tests=("controller/tests/properties/test_lji_properties.py",),
        python_paths=("packages/protocol/src",),
    ),
    MutationCase(
        ...
        mutant="if False:",
        tests=("controller/tests/properties/test_equal_sag_properties.py",),
        python_paths=("packages/protocol/src",),
    ),
)
