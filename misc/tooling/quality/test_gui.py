...
SOURCE_ROOTS = (
    ...
    ROOT / "simulator/src",
    ROOT / "ui/src",
    ROOT / "misc/tooling/model_builder/src",
)
WINDOW_W = 1280
WINDOW_H = 760
LEFT_W = 350.0
...
TEST_GROUPS += (
    ...
    TestCaseGroup("모델 빌더", _under("misc/tooling/model_builder/tests/"), "blueprint와 URDF 생성 계약을 확인합니다."),
    TestCaseGroup("개발 도구", _under("misc/tooling/"), "분석기, 로그뷰어와 실험 CLI의 순수 helper를 확인합니다."),
)
