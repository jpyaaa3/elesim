"""Build and validate immutable simulator model bundles."""
...
class BundleIntegrityError(ValueError):
    """Raised when a simulator model bundle is incomplete or was modified."""
...
def _validate_metadata(metadata: dict[str, Any]) -> dict[str, dict[str, object]]:
    ...
    if metadata.get("entrypoints") != ENTRYPOINTS:
        raise BundleIntegrityError("bundle entrypoints do not match the simulator contract")
