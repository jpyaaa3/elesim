...
echo ""
echo "Cases (edit the simulator config mpc_pitch_trim_* then restart elesim-simulator each time):"
...
echo "  elesim-simulator --config simulator/config/default.yaml"
echo "  python misc/tooling/experiments/walking_baseline.py --run-id \$ELESIM_RUN_ID \\"
echo "    --preset bent_upward --motion backward --duration 15 --vx -0.35 --gaze off"
echo ""
echo "Compare:"
echo "  python misc/tooling/analysis/analyze_walking_metrics.py --evaluate-trim exp_trim_baseline_001 exp_trim_<case>_001"
