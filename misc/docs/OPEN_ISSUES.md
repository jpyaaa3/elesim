...
> `misc/model/source/assets` and `model/bundles/default`. Historical observations
...
- See `misc/docs/audit/2026-07-20/coverage.md`. These gaps require integration rigs,
