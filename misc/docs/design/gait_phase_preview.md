...
- `controller/src/elesim_controller/config`: gait period, horizon, template path, bins, phase offset, and
  scale configuration.
- `controller/src/elesim_controller/observability`: phase source, current/future template values, preview
