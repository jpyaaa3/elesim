...
Full stack (requires elesim-sim; this tool owns Pilot on the DDS graph):
  ELESIM_PROFILE_PICK=1 python research/debug/profile_pick_e2e.py --phases look,ready

Compute-only (no host):
  ELESIM_PROFILE_PICK=1 python research/debug/profile_pick_e2e.py --compute-only --cprofile
"""
