#!/usr/bin/env python3
"""Genesis simulation endpoint with protocol-v2 transport."""
...
from engine.vision.webrtc import WebRtcVideoSender, available as webrtc_available
...
def _runtime_config(source: str, state_endpoint: str, feedback_endpoint: str) -> str:
    document = {
        "schema_version": 1,
...
def _run() -> None:
    ...
    parser.add_argument("--runtime-config", default=str(_ROOT / "configs/runtime/sim.yaml"))
    ...
    bridge.start()
    generated = _runtime_config(args.config, args.legacy_state, args.legacy_feedback)
    try:
        from apps.sim.main import main as run_genesis
