...
def _simulator_frame(sample: RgbdSample) -> SimCameraFrame:
...
class SimCameraSubscriber:
    ...
    def recv_latest(
        ...
        *,
        ...
        return None if sample is None else _simulator_frame(sample)


__all__ = ["SimCameraSubscriber", "_simulator_frame"]
