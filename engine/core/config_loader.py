...
def _load_pick_config(cp: configparser.ConfigParser, defaults: AppConfigBundle) -> PickConfig:
    ...
    return PickConfig(
        ...
        lij_sample_cmd_meas_cos_min=cp.getfloat(
            "pick",
            "lij_sample_cmd_meas_cos_min",
            fallback=pk0.lij_sample_cmd_meas_cos_min,
        ),
        lij_sample_meas_cmd_ratio_min=cp.getfloat(
            "pick",
            "lij_sample_meas_cmd_ratio_min",
            fallback=pk0.lij_sample_meas_cmd_ratio_min,
        ),
        lij_sample_meas_cmd_ratio_max=cp.getfloat(
            "pick",
        ...
        lij_obs_max_camera_z_m=cp.getfloat(
            "pick", "lij_obs_max_camera_z_m", fallback=pk0.lij_obs_max_camera_z_m
        ),
...
def _load_roll_scan_config(
    ...
    return RollScanConfig(
        ...
        home_roll_deg=g("home_roll_deg", r0.home_roll_deg),
        return_home=cp.getboolean("roll_scan", "return_home", fallback=r0.return_home),
        home_timeout_s=g("home_timeout_s", r0.home_timeout_s),
...
def _load_hardware_config(cp: configparser.ConfigParser) -> HardwareConfig:
    ...
    return HardwareConfig(
        ...
        arm_latency_log_enable=cp.getboolean(
            "hardware", "arm_latency_log_enable", fallback=hw0.arm_latency_log_enable
        ),
        ...
        lji_velocity_min_linear_deg_s=cp.getfloat(
            "hardware", "lji_velocity_min_linear_deg_s", fallback=hw0.lji_velocity_min_linear_deg_s
        ),
        lji_velocity_min_roll_deg_s=cp.getfloat(
            "hardware", "lji_velocity_min_roll_deg_s", fallback=hw0.lji_velocity_min_roll_deg_s
        ),
        lji_velocity_min_s1_deg_s=cp.getfloat(
            "hardware", "lji_velocity_min_s1_deg_s", fallback=hw0.lji_velocity_min_s1_deg_s
        ),
        lji_velocity_min_s2_deg_s=cp.getfloat(
            "hardware", "lji_velocity_min_s2_deg_s", fallback=hw0.lji_velocity_min_s2_deg_s
        ),
