...
_NEXT_STAGE_OPTIONS = {
    ...
    "VIEW_ALIGN": ["LOOK_ALIGN", "STOP_AND_CHECK"],
    "STOP_AND_CHECK": ["LOOK_ALIGN"],
    "LOOK_ALIGN": ["ADVANCE_SMALL", "STOP_AND_CHECK", "COMMIT_GATE"],
    "ADVANCE_SMALL": ["STOP_AND_CHECK"],
    "COMMIT_GATE": ["SHORT_APPROACH", "LOOK_ALIGN"],
    "SHORT_APPROACH": ["CLOSE_GRIPPER"],
    "CLOSE_GRIPPER": ["LIFT_AND_VERIFY"],
    "LIFT_AND_VERIFY": ["TARGET_LOCK"],
}
