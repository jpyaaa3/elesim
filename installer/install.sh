...
raw_url="${ELESIM_BOOTSTRAP_URL:-https://raw.githubusercontent.com/${repository}/${ref}/installer/bootstrap.py}"
...
docker_args=(
  ...
  --env "ELESIM_VERBOSE=${ELESIM_VERBOSE:-0}"
  --env "ELESIM_BUILD_PROGRESS=${ELESIM_BUILD_PROGRESS:-compact}"
